...
public class APSWorkTimeCalcUtils {
	...
	private List<APSMessage> CheckBuildTask(List<APSTaskPart> wBuilderTaskList, int wFQTY) {
		List<APSMessage> wResult = new ArrayList<APSMessage>();
	 ...
	 * @return 空闲时间区间
	 */
	public Map<Calendar, Calendar> CalcFreeTimeInterval(List<APSTaskPart> wBuilderTaskList, int wFQTY,
			Calendar wStartime) {
