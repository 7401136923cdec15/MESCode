...
import com.mes.code.server.service.mesenum.APSMsgTypes;
...
import com.mes.code.server.service.mesenum.OMSOrderPriority;
import com.mes.code.server.service.mesenum.OMSOrderStatus;
import com.mes.code.server.service.po.OutResult;
import com.mes.code.server.service.po.aps.APSDismantling;
import com.mes.code.server.service.po.aps.APSInstallation;
...
import com.mes.code.server.service.po.oms.OMSOutsourceOrder;
...
//						wAllZoneList, wCalendarMap);
	...
	private void EditTaskTime(BMSEmployee wLoginUser, APSTaskPart wTaskPart, APSShiftPeriod wShiftPeriod,
		...
		if (wTaskPart.WorkHour > 0) {
			...
			Calendar wWorkEndTime = APSWorkTimeCalcUtils.getInstance().CalcTaskEndTime(wLoginUser, wTaskPart.PartID,
